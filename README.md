...
- 🔍 Dataset includes Uber pickups from April to September
...
This directory contains data on over 4.5 million Uber pickups in New York City from April to September, and 14.3 million more Uber pickups from January to June. However, for the sake of this iteration of the project, only the data from April was used, with over 500,000 lines of data. The features in this dataset are Date/Time, Latitude, Longitude, Base. I am not using Base for the sake of this experiment. Additionally, the data from January to June does not provide Latitude and Longitude data, so it will not be used in future experiments.
